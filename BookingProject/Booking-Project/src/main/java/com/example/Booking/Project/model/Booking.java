...
public class Booking {
    ...
    private String VehicleName; // starts with uppercase
    ...
    public Booking(String name, String mobileno, String emailId, String city, String address, String pincode,
                   String VehicleName, String vehiclemodel, String servicedetails, String servicedate, String servicetime, String status) {
        this.name = name;
